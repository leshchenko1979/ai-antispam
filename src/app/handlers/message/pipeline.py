...
async def _handle_trusted_member_exit(message: types.Message, user_id: int) -> None:
    """Save message lookup entry for a trusted member before early-exiting."""
    try:
...
def _set_classification_span_attributes(
    target_span: Any,
    is_spam: bool,
    confidence: int,
    reason: str,
